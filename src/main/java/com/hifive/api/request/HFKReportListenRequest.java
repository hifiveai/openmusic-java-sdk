...
import com.hifive.api.response.HFKReportListenResponse;

import java.util.Map;

public class HFKReportListenRequest extends HFBaseRequest<HFKReportListenResponse> {
    ...
    @Override
    public Class<HFKReportListenResponse> getResponseClass() {
        return HFKReportListenResponse.class;
    }
