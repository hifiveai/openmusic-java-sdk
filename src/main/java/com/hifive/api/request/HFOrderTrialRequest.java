...
import com.hifive.api.response.HFOrderTrialResponse;

import java.util.Map;

public class HFOrderTrialRequest extends HFBaseRequest<HFOrderTrialResponse> {
    ...
    @Override
    public Class<HFOrderTrialResponse> getResponseClass() {
        return HFOrderTrialResponse.class;
    }
