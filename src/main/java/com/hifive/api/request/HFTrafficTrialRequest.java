...
import com.hifive.api.response.HFTrafficTrialResponse;

import java.util.Map;

public class HFTrafficTrialRequest extends HFBaseRequest<HFTrafficTrialResponse> {
    ...
    @Override
    public Class<HFTrafficTrialResponse> getResponseClass() {
        return HFTrafficTrialResponse.class;
    }
