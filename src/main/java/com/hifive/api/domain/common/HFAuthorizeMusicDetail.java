...
public class HFAuthorizeMusicDetail extends HFBaseMusic {
    /**
     * UPC
     */
    @ApiField("upc")
     ...
     */
    @ApiField("lyric")
    private HifiveMusicLyric lyric;
    ...
    public HifiveMusicLyric getLyric() {
        return lyric;
    }

    public void setLyric(HifiveMusicLyric lyric) {
        this.lyric = lyric;
    }
