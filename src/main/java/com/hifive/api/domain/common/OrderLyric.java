...
@AllArgsConstructor
@NoArgsConstructor
public class OrderLyric extends HFObject {
    @ApiField("subject")
    ...
    @ApiListField("music")
    private List<HFMusicLyricFile> music;
    ...
    public List<HFMusicLyricFile> getMusic() {
        return music;
    }

    public void setMusic(List<HFMusicLyricFile> music) {
        this.music = music;
    }
}
